...
/* #define CPU_MILLIVOLTS {\
	750, 762, 775, 787, 800, 825, 837, 850, 862, 875, 887, 900, 912, 916, 925, 937, 950, 962, 975, 987, 1000, 1007, 1012, 1025, 1037, 1050, 1062, 1075, 1087, 1100, 1112, 1125, 1137, 1150, 1162, 1175, 1187, 1200, 1212, 1237}; ORIGINAL */

#define CPU_MILLIVOLTS {\
	637, 650, 662, 675, 700, 712, 725, 737, 750, 762, 775, 787, 800, 825, 837, 850, 862, 875, 887, 900,  912,  925,  937,  950,  975,  987,  1000, 1012, 1037, 1050, 1062, 1075, 1100, 1112, 1125, 1137, 1150, 1175, 1225, MAX_CPU_VOLTAGE }; // +1 and increase volts in last 3
...
static const int core_millivolts[MAX_DVFS_FREQS] = {
	950, 1000, 1050, 1100, 1150, 1200, 1250, 1350, MAX_CORE_VOLTAGE};  
...
static struct dvfs_rail tegra3_dvfs_rail_vdd_cpu = {
	.reg_id = "vdd_cpu",
	.max_millivolts = CPU_VOLTAGE_CAP, 
	.min_millivolts = 650,
	.step = VDD_SAFE_STEP,
	.jmp_to_zero = true,
};
...
static struct dvfs_rail tegra3_dvfs_rail_vdd_core = {
	.reg_id = "vdd_core",
	.max_millivolts = CORE_VOLTAGE_CAP,
	.min_millivolts = 900,
	.step = VDD_SAFE_STEP,
};
...
static struct dvfs cpu_dvfs_table[] = {
	/* Cpu voltages (mV):	      750,  775, 787, 800, 825, 837, 850, 862, 875, 887, 900, 912,  916,  925,  937,  950,    962,  975,  987, 1000, 1007, 1012, 1025, 1037, 1050, 1062, 1075, 1087, 1100, 1112, 1125, 1137, 1150, 1162, 1175, 1187, 1200, 1250, 1300,  MAX_CPU_VOLTAGE}; */
	CPU_DVFS("cpu_g",  5, 3, MHZ,   1,  475, 475, 475, 620, 620, 620, 620, 760, 760, 760, 760,  760,  910,  910,  1000,  1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1500, 1700, MAX_CPU_FREQUENCY),
	CPU_DVFS("cpu_g",  5, 4, MHZ,   1,  475, 475, 475, 620, 620, 620, 620, 760, 760, 760, 760,  760,  910,  910,  1000,  1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1500, 1700, MAX_CPU_FREQUENCY),

	CPU_DVFS("cpu_g", 12, 3, MHZ,   1,  475, 475, 475, 620, 620, 620, 620, 760, 760, 760, 760,  760,  910,  910,  1000,  1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1500, 1700, MAX_CPU_FREQUENCY),
	CPU_DVFS("cpu_g", 12, 4, MHZ,   1,  475, 475, 475, 620, 620, 620, 620, 760, 760, 760, 760,  760,  910,  910,  1000,  1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1500, 1700, MAX_CPU_FREQUENCY),
...
static struct dvfs cpu_0_dvfs_table[] = {
	...
	CPU_DVFS("cpu_0",  5, 3, MHZ, 475, 475, 620, 620, 760, 760, 760, 910,  910,  910, 1000, 1000, 1000, 1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1600, 1600, 1600, 1600, 1700, MAX_CPU_FREQUENCY),
	CPU_DVFS("cpu_0",  5, 4, MHZ, 475, 475, 620, 620, 760, 760, 760, 910,  910,  910, 1000, 1000, 1000, 1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1600, 1600, 1600, 1600, 1700, MAX_CPU_FREQUENCY),

	CPU_DVFS("cpu_0", 12, 3, MHZ, 475, 475, 620, 620, 760, 760, 760, 910,  910,  910, 1000, 1000, 1000, 1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1600, 1600, 1600, 1600, 1700, MAX_CPU_FREQUENCY),
	CPU_DVFS("cpu_0", 12, 4, MHZ, 475, 475, 620, 620, 760, 760, 760, 910,  910,  910, 1000, 1000, 1000, 1000, 1000, 1000, 1150, 1150, 1150, 1150, 1150, 1300, 1300, 1300, 1300, 1400, 1400, 1400, 1400, 1500, 1500, 1500, 1500, 1500, 1600, 1600, 1600, 1600, 1700, MAX_CPU_FREQUENCY),
...
static struct dvfs core_dvfs_table[] = {
	...
	CORE_DVFS("vde",    2, 1, KHZ,   200000, 247000, 304000, 352000, 400000,  437000,  484000,  650000,  MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("mpe",    2, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  446000,  484000,  650000,  MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("2d",     2, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  446000,  484000,  650000,  MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("epp",    2, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  446000,  484000,  650000,  MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("3d",     2, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  446000,  484000,  650000,  MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("3d2",    2, 1, KHZ,   200000, 247000, 304000, 361000, 408000,  446000,  484000,  650000,  MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("se",     2, 1, KHZ,   200000, 267000, 304000, 361000, 408000,  446000,  484000,  650000,  MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("host1x", 2, 1, KHZ,   100000, 152000, 188000, 222000, 254000,  267000,  267000,  MAX_HOST1X_FREQUENCY * 1000,  MAX_HOST1X_FREQUENCY * 1000),
	CORE_DVFS("cbus",   2, 1, KHZ,   200000, 247000, 304000, 352000, 400000,  437000,  484000,  650000,  MAX_CORE_FREQUENCY * 1000 ),
	CORE_DVFS("pll_c",  -1, 1, KHZ,  533000, 667000, 667000, 800000, 800000, 1066000, 1066000, 1200000,  MAX_CORE_FREQUENCY * 1000 * 2 ),
...
static void __init init_dvfs_one(struct dvfs *d, int nominal_mv_index)
{
	 ...
	 * check the scaling ladder against nominal  voltage when the table
 ...
 */
static int __init set_gpu_speed(void)
{
   ...
   freq = CORE_DEFAULT_OC_FREQUENCY;
   volt = CORE_DEFAULT_OC_VOLT;

   /* check */
   if(volt > CORE_VOLTAGE_CAP || freq > CORE_FREQUENCY_CAP)
      return -EINVAL;
   ...
   vde->dvfs->millivolts[CORE_MAXFREQ_IDX] = volt;
   vde->dvfs->freqs[ CORE_MAXFREQ_IDX] = new_gpu_freq;
   mpe->dvfs->freqs[ CORE_MAXFREQ_IDX] = new_gpu_freq;
   two_d->dvfs->freqs[ CORE_MAXFREQ_IDX] = new_gpu_freq;
   epp->dvfs->freqs[ CORE_MAXFREQ_IDX] = new_gpu_freq;
   three_d->dvfs->freqs[ CORE_MAXFREQ_IDX] = new_gpu_freq;
   three_d2->dvfs->freqs[ CORE_MAXFREQ_IDX] = new_gpu_freq;
   se->dvfs->freqs[ CORE_MAXFREQ_IDX] = new_gpu_freq;
   cbus->dvfs->freqs[ CORE_MAXFREQ_IDX] = new_gpu_freq;
   pll_c->dvfs->freqs[ CORE_MAXFREQ_IDX] = (new_gpu_freq*2);
   pr_info("NEW PLL_C FREQS: %lu\n", pll_c->dvfs->freqs[ CORE_MAXFREQ_IDX]);
...
void __init tegra_soc_init_dvfs(void)
{
	...
	pr_info("[alex] cpu_speedo: %d, soc_speedo: %d, cpu_process %d, core_process %d\n", cpu_speedo_id, soc_speedo_id, cpu_process_id, core_process_id); //ORIGINAL
